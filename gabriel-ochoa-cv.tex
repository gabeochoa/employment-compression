...
{Binghamton, New York} {
    ...
    {
        \begin{itemize}
            \item Data Structures / Algorithms / Obj Oriented Prog I/II/III
            \item Graphics Programming / Image Processing / Computer Vision 
        \end{itemize}
    }
}
...
{
    \headedsubsection
    {Tech Lead / Senior Software Engineer - Live Destination (FB) }
    {July 2019 - Present}
    {
        \begin{itemize}
            \item Led creation of Live Explore page: {\href{http://www.facebooklive.com/}{facebooklive.com}}
            \item Contributes to 2\% of global live watch time and 20\% of Web
            \item Mentorship of interns, senior and junior engineers
        \end{itemize}
    }
}
...
{New York, New York}
{
    ...
    {
        \begin{itemize}
            \item Tutored students on full stack web development
            \item Held office hours to assist on lab assignments / projects
            \item Career Mentorship and Mock Interview Practice 
        \end{itemize}
    }
}
...
{ Python, Hack, JavaScript, C++, Java, C\#, C, Bash, Perl }

\inlineskillsection  
{Frameworks / Libraries:}
{ React, Django/Flask, Unity, OpenGL, SFML, GraphQL, NodeJS}
