...
{New York, New York}
{
    ...
    {
        \begin{itemize}
            \item Brought polling to Reels and VOD, significantly increasing views and comments for creators
            \item Developed AR Gifting features which grew tips to participating Creators by 60\%
        \end{itemize}
    ...
    {Aug 2022 - Aug 2023}
    {
        \begin{itemize}
            ...
            \item Built a system for a set of interactive stickers that overlay on live videos [Patent]
